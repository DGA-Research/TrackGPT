...
TEXT_HIGHLIGHT_PROMPT_TEMPLATE = """# ROLE: Meticulous Communications Analyst & Information Extractor
...
# 6. **Time Stamp (Per Bullet):** Using the time stamps on the input transcript, identify the starting time stamp at which the statement was said. Ex: [0:00:06.88]
